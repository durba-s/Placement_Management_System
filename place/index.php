	    ...
	    <div class="container-fluid">   
		    ...
		    <div class="col-md-3 col-lg-2 bg-light" id="left-nav-bar" style="padding-left:0; padding-right:0;">
		  	...
		  	<main role="main" class="col-12 col-md-9 col-xl-8 py-md-3 pl-md-5 content">
		        <h3>Courses Taken</h3>
				<?php
				$query = "select c.courseid,c.name,c.creds,t1.grade from stud_course t1,student t2,course c where t1.sid=t2.sid and c.courseid=t1.courseid and t2.sid={$_SESSION['uid']}";
